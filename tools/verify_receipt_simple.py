...
class CIAFVerifier:
    ...
    def verify_receipt(receipt_data: Dict[str, Any]) -> bool:
        ...
        if "model" in receipt_data:
            ...
            if "parameters_fingerprint" in model_info:
                ...
                if not param_valid:
                    ...
                    print("   Parameter fingerprint mismatch!")
                    valid = False
            ...
            if "architecture_fingerprint" in model_info:
                ...
                if not arch_valid:
                    ...
                    print("   Architecture fingerprint mismatch!")
                    valid = False
        ...
        if "audit_records" in receipt_data:
            ...
            print(
                f"Audit connections: {'Valid' if CIAFVerifier.verify_audit_connections(audit_records) else 'Invalid'}"
            )
            ...
            for i, record in enumerate(audit_records):
                ...
                if expected_hash:
                    ...
                    print(
                        f"   Event {i+1}: {event_type} ({'Valid' if record_valid else 'Invalid'})"
                    )
