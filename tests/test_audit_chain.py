...
class MockAuditRecord:
    ...
    def __init__(
        self, event_id: str, event_type: str, timestamp: str, previous_hash: str = None
    ):
    ...
    def _calculate_hash(self) -> str:
        ...
        data = (
            f"{self.event_id}|{self.event_type}|{self.timestamp}|{self.previous_hash}"
        )
...
class TestAuditConnections:
    ...
    def test_audit_connections_tampering_detection(self):
        ...
        record2 = MockAuditRecord(
            "event_2", "type_2", "2025-09-12T10:01:00Z", record1.hash
        )
        record3 = MockAuditRecord(
            "event_3", "type_3", "2025-09-12T10:02:00Z", record2.hash
        )
        ...
        record2_tampered = MockAuditRecord(
            "event_2_modified", "type_2", "2025-09-12T10:01:00Z", record1.hash
        )
    ...
    def test_audit_connections_missing_link(self):
        ...
        record4 = MockAuditRecord(
            "event_4", "type_4", "2025-09-12T10:03:00Z", "fake_hash"
        )
