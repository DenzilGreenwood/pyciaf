...
class TestIdempotency:
    ...
    def test_deterministic_receipt_generation(
        self, dataset_anchor, model_anchor, random_seed
    ):
...
if __name__ == "__main__":
    if HYPOTHESIS_AVAILABLE:
        ...
        try:
            test_class.test_evidence_strength_determination(
                {"comp1": True, "comp2": False}
            )
        ...
        print(
            "Install hypothesis for full property-based testing: pip install hypothesis"
        )
