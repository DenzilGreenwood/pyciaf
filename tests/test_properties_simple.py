...
def test_training_receipt_validation():
    ...
    try:
        from ciaf.enhanced_receipts import TrainingReceipt, RandomSeeds, EnvironmentInfo, PYDANTIC_AVAILABLE
...
def test_evidence_strength():
    ...
    try:
        ...
        assert strength in [EvidenceStrength.REAL, EvidenceStrength.SIMULATED, EvidenceStrength.FALLBACK]
