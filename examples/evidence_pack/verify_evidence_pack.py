...
try:
    ...
    print("Ensure you're running from the evidence_pack directory with ../../ciaf/ available")
    sys.exit(1)
...
def main():
    ...
    if anchor["root"] != root_hash:
        print(f"❌ Anchor root ≠ Merkle root")
    ...
    print(f"   🔐 Manifest signature: Valid Ed25519")
    print(f"   🌳 Merkle proof steps: {len(merkle_path)}")
    print(f"   ⚓ Anchor signature: Valid Ed25519")
    print(f"   🔗 Root linkage: Anchor ↔ Merkle ↔ Capsule")
    print(f"   📝 Provenance: enhanced_core_demo.py v1.0.0")
