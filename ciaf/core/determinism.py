...
class DeterministicTimestampGenerator:
    ...
    def __init__(
        self, clock: Optional[DeterministicClock] = None, base_entropy: str = "ciaf"
    ):
        """
    ...
    def generate_timestamp(
        self, operation_id: str = "", additional_entropy: str = ""
    ) -> str:
        """
    ...
    def generate_timestamped_id(
        self, prefix: str = "id", operation_id: str = ""
    ) -> str:
        """
...
def deterministic_timestamp(
    operation_id: str = "", additional_entropy: str = ""
) -> str:
    """Generate deterministic timestamp for an operation."""
    return default_timestamp_generator.generate_timestamp(
        operation_id, additional_entropy
    )
...
class DeterministicContext:
    ...
    def __enter__(self):
        ...
        default_clock = DeterministicClock(self.fixed_time)
        default_timestamp_generator = DeterministicTimestampGenerator(
            default_clock, self.base_entropy
        )
