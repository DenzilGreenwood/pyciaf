...
class CIAFTestVectors:
    ...
    def generate_merkle_vectors(self) -> List[TestVector]:
        ...
        for i, leaves in enumerate(test_cases):
            ...
            for leaf in leaves:
                ...
                proofs[leaf] = {"proof": proof, "valid": is_valid}
            ...
            vectors.append(
                TestVector(
                    ...
                    expected_outputs={"root": root, "proofs": proofs},
        ...
        for i, message in enumerate(test_messages):
            ...
            vectors.append(
                TestVector(
                    ...
                    inputs={"message": message, "key_id": signer.key_id},
                    expected_outputs={
                        "signature": signature,
    ...
    def generate_anchor_vectors(self) -> List[TestVector]:
        ...
        test_roots = ["a" * 64, "b" * 64, sha256_hash(b"test_root")]
    ...
    def validate_implementation(
        self, implementation_vectors: TestVectorSuite
    ) -> Dict[str, Any]:
        """
