...
class LCMModelAnchor:
    ...
    def __init__(
        ...
        self.model_anchor = self.anchor_deriver.derive_model_anchor(
            self.master_anchor, self.model_hash
        )
...
class LCMModelManager:
    ...
    def get_model_anchor(
        ...
        matching_keys = [
            k for k in self.model_anchors.keys() if k.startswith(f"{model_name}_")
        ]
        if matching_keys:
