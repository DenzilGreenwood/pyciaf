...
class ProcessingPolicy:
    ...
    feature_selection_method: str = (
        "variance"  # "variance", "correlation", "univariate", "rfe"
    )
...
class PreprocessingPolicy:
    ...
    def format_policy_line(self) -> str:
        ...
        quality_level = (
            "strict"
            if self.quality_policy.min_quality_score >= 85
            else (
                "standard"
                if self.quality_policy.min_quality_score >= 70
                else "permissive"
            )
        )
        ...
        return (
            f"preprocessing: quality={quality_level} | "
...
def create_custom_policy(
    ...
    **kwargs,
    ...
    if processing_intensity == PreprocessingIntensity.MINIMAL:
        ...
        base_policy.processing_policy.text_max_features = min(
            1000, base_policy.processing_policy.text_max_features
        )
        ...
        base_policy.processing_policy.text_max_features = max(
            20000, base_policy.processing_policy.text_max_features
        )
