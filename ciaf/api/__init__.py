...
def create_api_framework(policy: APIPolicy = None, framework_type: str = "auto") -> Any:
    """
    ...
    # Fall back to legacy framework
        ...
        raise ImportError(
            f"No API framework implementation available for type: {framework_type}"
        )
