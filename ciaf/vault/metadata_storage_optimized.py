...
class HighPerformanceMetadataStorage:
    ...
    def __init__(
        self, config_or_template: Union[str, Dict[str, Any]] = "high_performance"
    ):
        """
        ...
        self.memory_buffer = deque(
            maxlen=self.perf_config.get("memory_buffer_size", 1000)
        )
    ...
    def get_performance_stats(self) -> Dict[str, Any]:
        ...
        avg_save_time = (
            self.total_save_time / self.total_saves if self.total_saves > 0 else 0.0
        )
