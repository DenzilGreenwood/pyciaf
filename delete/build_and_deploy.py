...
class CIAFBuilder:
    ...
    def build_package(self):
        """Build the package"""
        return self.run_command("python -m build", 
                              "Building package distributions")
    
    def check_package(self):
        """Check package with twine"""
        return self.run_command("python -m twine check dist/*", 
    ...
    def deploy_to_testpypi(self):
        ...
        return self.run_command("python -m twine upload --repository testpypi dist/*", 
    ...
    def deploy_to_pypi(self):
        ...
        return self.run_command("python -m twine upload dist/*", 
...
def main():
    ...
    parser.add_argument("--build-only", action="store_true", 
                       help="Build without deploying")
    parser.add_argument("--test-only", action="store_true", 
                       help="Only run tests")
    parser.add_argument("--deploy-test", action="store_true", 
                       help="Deploy to TestPyPI")
    parser.add_argument("--deploy-prod", action="store_true", 
                       help="Deploy to production PyPI")
    parser.add_argument("--full", action="store_true", 
                       help="Clean, build, test, and deploy to TestPyPI")
